...
public class WelcomeActivity extends AwesomeSplash
{
    ...
    public void initSplash(ConfigSplash configSplash)
    {
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.nw_icc); //or any other drawable
        configSplash.setOriginalWidth(10);
        configSplash.setOriginalHeight(20);
        ...
        //Customize Title
        configSplash.setTitleSplash("News Watch"); //change your app name here
        configSplash.setTitleTextColor(R.color.Wheat);
        configSplash.setTitleTextSize(30f); //float value
        configSplash.setAnimTitleDuration(3000);
        configSplash.setAnimTitleTechnique(Techniques.FlipInX);
        configSplash.setTitleFont("fonts/lobster.ttf"); //provide string to your font located in assets/fonts/
    }
